...
CONFIG = [
    ...
    },
    {
        'id': 4,
        'name': 'above_head',
        'directory': 'above_head',
        'required': False,
        'rarity_weights': [100, 5, 10, 5, 15, 10, 5, 5, 1],
    },
    {
        'id': 5,
        'name': 'mouth',
    ...
    },
    {
        ...
        'directory': 'face',
        'required': False,
        'rarity_weights': [100, 5, 10, 5, 15, 10, 5, 5],
    },
    {
        'id': 8,
        'name': 'mouth_accessory',
        'directory': 'mouth_accessory',
        'required': False,
        'rarity_weights': [100, 5, 10, 5, 15, 10, 5, 1],
    },
        {
        'id': 9,
        'name': 'mask',
        'directory': 'mask',
        'required': False,
        'rarity_weights': [100, 5, 10, 5, 15, 10],
    }
]
