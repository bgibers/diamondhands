...
module.exports = async ({ getNamedAccounts, deployments, getChainId }) => {
  ...
  */
  ...
  const DiamondHands = await deploy("DiamondHands", [], {
  ...
  */
  ...
  //       address: DiamondHands.address,
  //       contract: "contracts/DiamondHands.sol:DiamondHands",
...
module.exports.tags = ["DiamondHands"];
